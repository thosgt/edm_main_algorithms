...
from encode import add_one_feature_counter_in_one_time_window, add_feature_counters_in_one_time_window, scaling_function
...
def test_add_one_feature_wins_in_one_time_window():
    ...
    counter = 'wins'
    time_window = '1d'
    df = pd.DataFrame({'timestamp': ['2019-03-01 00:00:01', '2019-03-01 00:00:02', '2019-03-01 00:00:03', '2019-03-01 00:00:04', '2019-03-03 00:00:04'],
                       'student_id': [1, 1, 1, 2, 1], 
                       'lesson_id': [101] * 5, 
    ...
    expected_df_with_counter = pd.DataFrame({'timestamp': ['2019-03-01 00:00:01', '2019-03-01 00:00:02', '2019-03-01 00:00:03', '2019-03-01 00:00:04', '2019-03-03 00:00:04'],
                                'student_id': [1, 1, 1, 2, 1], 
                                'lesson_id': [101] * 5, 
                                'correctness': [1, 0, 1, 1, 1],
                                f'{feature}_{counter}_in_the_past_{time_window}': scaling_function(np.array([0.0, 1.0, 1.0, 0.0, 0.0]))})
...
def test_add_one_feature_attempts_in_one_time_window():
    ...
    expected_df_with_counter = pd.DataFrame({'timestamp': ['2019-03-01 00:00:01', '2019-03-01 00:00:02', '2019-03-01 00:00:03', '2019-03-01 00:00:04'],
                                ...
                                'lesson_id': [101] * 4, 
                                'correctness': [1, 0, 1, 1],
                                f'{feature}_{counter}_in_the_past_{time_window}': scaling_function(np.array([0.0, 1.0, 2.0, 0.0]))})
    expected_df_with_counter["timestamp"] = pd.to_datetime(expected_df_with_counter["timestamp"])
    assert_frame_equal(df_wins, expected_df_with_counter)
...
def test_add_one_feature_counters_in_one_time_window():
    ...
    expected_df_with_counter = pd.DataFrame({'timestamp': ['2019-03-01 00:00:01', '2019-03-01 00:00:02', '2019-03-01 00:00:03', '2019-03-01 00:00:04'],
                                ...
                                'lesson_id': [101] * 4, 
                                'correctness': [1, 0, 1, 1],
                                f'{feature}_{counters[0]}_in_the_past_{time_window}': scaling_function(np.array([0.0, 1.0, 2.0, 0.0])),
                                f'{feature}_{counters[1]}_in_the_past_{time_window}': scaling_function(np.array([0.0, 1.0, 1.0, 0.0]))})
    expected_df_with_counter["timestamp"] = pd.to_datetime(expected_df_with_counter["timestamp"])
    assert_frame_equal(df_with_counter, expected_df_with_counter)


def test_add_one_feature_attempts_is_not_impacted_by_multiple_students():
    feature = 'lesson_id'
    counter = 'attempts'
    time_window = '1d'
    ...
    df_wins = add_one_feature_counter_in_one_time_window(
        df, feature=feature, counter=counter, time_window=time_window)
    expected_df_with_counter = pd.DataFrame({'timestamp': ['2019-03-01 00:00:01', '2019-03-01 00:00:02', '2019-03-01 00:00:03', '2019-03-01 00:00:04', '2019-03-01 00:00:05'],
                                'student_id': [1, 1, 1, 2, 1], 
                                'lesson_id': [101] * 5, 
                                'correctness': [1, 0, 1, 1, 1],
                                f'{feature}_{counter}_in_the_past_{time_window}': scaling_function(np.array([0.0, 1.0, 2.0, 0.0, 3.0]))})
    expected_df_with_counter["timestamp"] = pd.to_datetime(expected_df_with_counter["timestamp"])
    assert_frame_equal(df_wins, expected_df_with_counter)